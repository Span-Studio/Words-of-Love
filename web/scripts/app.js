(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["/web/scripts/app"],{
...
var Global = __webpack_require__(/*! ./global.js */ "./app/scripts/global.js");

var Videos = __webpack_require__(/*! ./videos.js */ "./app/scripts/videos.js");

var Galeries = __webpack_require__(/*! ./galeries.js */ "./app/scripts/galeries.js");
...
var Gallery = function Gallery(element, options) {
    ...
    on: {
      ready: function ready() {
        $('.flickity-page-dots .dot').each(function (i) {
          $(this).prepend("<span>".concat(i + 1, "</span>"));
        });
      },
      select: function select(index) {
        var $el = $(this.cells[index].element);
      ...
      $form.submit(function (event) {
        if (!$form.data("default")) {
          ...
          $.ajax({
            ...
            complete: function complete(response, textStatus) {
...
var YouTubePlayer = __webpack_require__(/*! youtube-player */ "./node_modules/youtube-player/dist/index.js");

var _ = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js");

var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js"); // https://github.com/vimeo/player.js/
...
var VimeoPlayer = /*#__PURE__*/function () {
  ...
  function VimeoPlayer(el) {
    ...
    this.player = new Vimeo.Player(el, options); // this.resizeHelper();
  }
...
var Youtube = function Youtube(el) {
  ...
  this.player.on("ready", function (event) {
    ...
    var calc = function calc() {
      console.log(event.target, event.target.getIframe(), $player.innerWidth(), $player.innerWidth() * ratio);
      event.target.setSize($player.innerWidth(), $player.innerWidth() * ratio);
    };
...
/***/ 0:
/*!******************************************************************************!*\
  !*** multi ./app/scripts/app.js ./app/styles/main.scss ./app/styles/cp.scss ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /Users/clark/Documents/span/love/app/scripts/app.js */"./app/scripts/app.js");
__webpack_require__(/*! /Users/clark/Documents/span/love/app/styles/main.scss */"./app/styles/main.scss");
module.exports = __webpack_require__(/*! /Users/clark/Documents/span/love/app/styles/cp.scss */"./app/styles/cp.scss");


/***/ })

},[[0,"/web/scripts/manifest","/web/scripts/vendor"]]]);